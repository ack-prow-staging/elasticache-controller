...
// +kubebuilder:rbac:groups=elasticache.services.k8s.aws,resources=cachesecuritygroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=elasticache.services.k8s.aws,resources=cachesecuritygroups/status,verbs=get;update;patch
