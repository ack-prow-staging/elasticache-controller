...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.CacheSecurityGroupName = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	f0, ok := fields["cacheSecurityGroupName"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: cacheSecurityGroupName"))
	}
	r.ko.Spec.CacheSecurityGroupName = &f0
